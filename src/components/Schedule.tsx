...
// tryoutData, so they stay local.
const coaches: { name: string; role?: string }[] = [
  ...LIGHTNING_TEAMS.map((t) => ({
    name: t.headCoach,
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
                ...
                {coaches.map((coach, i) => (
                  <div key={i} className="text-white/80 flex flex-col items-center">
                    <div className="flex items-center justify-center gap-2">
                      <svg aria-hidden="true" className="w-4 h-4 text-gold-500/60" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M13 0L0 14h9l-2 10 13-14h-9l2-10z" />
                      </svg>
                      {coach.name}
                    </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-white/80 text-center">
                <span className="text-gold-500 font-bold text-2xl">11</span> players per team
              </p>
